...
public class NickNameUsersActivity extends BaseTActivity {
            ...
            public void onClick(View v) {
                ...
                if (userName!=null){
                    if (NetWork.isNetworkConnected(getApplicationContext())) {
                        HttpUtil.sendOkHttpRequest("https://starlibrary.online/haopeng/user/revisename" +
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if (jsonMsg.getStatus() == 200) {
                                            ...
                                            LitePal.updateAll(UserIn.class, values, "username = ?", userName);
                                            finish();
