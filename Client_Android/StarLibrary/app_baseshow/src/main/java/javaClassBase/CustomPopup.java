...
public class CustomPopup extends CenterPopupView {
    ...
    public CustomPopup(@NonNull Context context,String title,String content) {
        super(context);
    ...
    protected void onCreate() {
        ...
        findViewById(R.id.tv_confirm).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(context,"开始下载starLibraray", Toast.LENGTH_LONG).show();
                new DownloadUtils(context,"https://starlibrary.online/starLibrary/"+title+".apk", title+".apk");
                dismiss();
            }
        });
