...
@Route(path = "/app_orders/OrderBorrowInActivity")
public class OrderBorrowInActivity extends MyActivity {
    @Autowired
    String orderName;
    @Autowired
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_borrow_in);
        ...
        TextView order_borrowout_header_ok=findViewById(R.id.order_borrowin_header_ok);
        ...
        TextView book_order_header_orderName=findViewById(R.id.order_borrowin_header_orderName);
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (jsonMsg.getStatus()==200){
                                if (!OrderBorrowInActivity.this.isDestroyed()) {
                                    Toast.makeText(OrderBorrowInActivity.this,jsonMsg.getMsg(),Toast.LENGTH_LONG).show();
                                    finish();
                                }
                            }else {
                                Toast.makeText(OrderBorrowInActivity.this,jsonMsg.getMsg(),Toast.LENGTH_LONG).show();
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (jsonMsgOrder.getStatus()==200){
                                if (!OrderBorrowInActivity.this.isDestroyed()) {
                                    LinearLayoutManager linearLayoutManager=new LinearLayoutManager(OrderBorrowInActivity.this);
                                    RecyclerView rv =findViewById(R.id.recycler_view);
                                    OrderSweepedOrderAdapter adapter = new OrderSweepedOrderAdapter(jsonMsgOrder.getData(),OrderBorrowInActivity.this);
